...
import { OtherFragances } from "@/components/OtherFragrances";
...
export default async function Page({ params }: { params: Promise<Params> }) {
  ...
  return (
    <Bounded className="py-10">
        <div className="grid grid-cols-1 items-center gap-10 pb-10 lg:grid-cols-2">
            <div className="relative mb-14 flex justify-center pb-10">
                <PrismicNextImage 
                    ...
                    height={600}
                    priority
                    className="absolute top-[90%] -scale-y-100 [mask-image:linear-gradient(to_bottom,rgba(0,0,0,0)_70%,rgba(0,0,0,0.20)_100%)]"
                />
                <PrismicNextImage 
                    field={page.data.bottle_image} 
                    width={600}
            ...
            <div className="text-white">
                ...
                <div className="space-y-6">
                    ...
                    <button className="w-full bg-white text-black py-3 font-medium uppercase transition hover:bg-neutral-200 duration-200">Add To Bag</button>

                    <div className="flex items-center border-t border-neutral-700 pt-6">
        ...
        <OtherFragances currentFragranceUid={uid} />
    </Bounded>
  );
}
...
export async function generateMetadata({
  ...
  return {
    ...
    description: `Discover ${page.data.title}, the newest fragrance from Côte de Royale Paris`,
    openGraph: {
