    ...
    >
      ...
      <div ref={contentRef}>
        ...
        <div ref={textRef} className="text-center">
          <p className="font-display flex flex-wrap justify-center text-5xl leading-tight text-balance 
          bg-no-repeat bg-cover bg-center outline-orange-500 bg-clip-text not-italic text-transparent
          uppercase md:text-7xl bg-[url('/fire.gif')] drop-shadow-[0_2px_22px_rgba(255, 0, 0, 0.8)] ">
